  ...
  "must-affirmative-plain": [
    ...
    },
    {
      ...
      transform: (verb) => {
        ...
        return (
          stem + transformations.godan.endings[ending].a + "なければならない"
        );
      },
    },
  ],
  "must-affirmative-polite": [
    ...
    },
    {
      ...
      transform: (verb) => {
        ...
        const ending = verb.ending as VerbEnding;
        return (
          stem + transformations.godan.endings[ending].a + "なければなりません"
        );
      },
    },
  ],
  ...
  "must-negative-polite": [
    ...
    },
    {
      ...
      transform: (verb) => {
        ...
        const ending = verb.ending as VerbEnding;
        return (
          stem + transformations.godan.endings[ending].a + "なくてもいいです"
        );
      },
    },
  ],
