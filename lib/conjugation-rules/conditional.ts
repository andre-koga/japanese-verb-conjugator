  ...
  "conditionalTara-affirmative-plain": [
    {
      ...
      transform: (verb) => {
        if (verb.type === "irregular") {
          ...
          if (
            verb.irregularForms &&
            verb.irregularForms["conditionalTara-affirmative-plain"]
          ) {
  ...
  "conditionalTara-affirmative-polite": [
    {
      ...
      transform: (verb) => {
        if (verb.type === "irregular") {
          ...
          if (
            verb.irregularForms &&
            verb.irregularForms["conditionalTara-affirmative-polite"]
          ) {
  ...
  "conditionalTara-negative-plain": [
    {
      ...
      transform: (verb) => {
        if (verb.type === "irregular") {
          ...
          if (
            verb.irregularForms &&
            verb.irregularForms["conditionalTara-negative-plain"]
          ) {
  ...
  "conditionalTara-negative-polite": [
    {
      ...
      transform: (verb) => {
        if (verb.type === "irregular") {
          ...
          if (
            verb.irregularForms &&
            verb.irregularForms["conditionalTara-negative-polite"]
          ) {
